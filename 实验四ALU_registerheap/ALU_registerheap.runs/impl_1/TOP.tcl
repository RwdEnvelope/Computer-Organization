...
namespace eval ::optrace {
  variable script "E:/project/xilinx/ALU_registerheap/ALU_registerheap.runs/impl_1/TOP.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet E:/project/xilinx/ALU_registerheap/ALU_registerheap.runs/synth_1/TOP.dcp
